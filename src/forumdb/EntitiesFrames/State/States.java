 ...
 * @author Masha
 */
public class States extends javax.swing.JDialog {
     ...
     * @param c
     */
    public States(java.awt.Frame parent, boolean modal, Connection c) {
        super(parent, modal);
        initComponents();
        connection = c;

        model = new StatesModel(connection);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NewState nu = new NewState((Frame) this.getParent(), true, connection);
        nu.setVisible(true);
        model.updateData();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            NewState nu = new NewState((Frame) this.getParent(), true, 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (jTable1.getSelectedRow() >= 0) {
            try {
                ...
                statement.executeUpdate("delete from state where id=" 
